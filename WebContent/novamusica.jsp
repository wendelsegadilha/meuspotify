		...
		<div class="row">
			<div class="col-md-12" id="cabecalho">
				<div id="logo" class="text-center">
					...
					<h1>Nova Música</h1>
					<h5>
						Envie suas músicas <strong>${Usuario.nome}</strong>
					</h5>
				</div>
			</div>
		</div>
				...
				<div id="form-login">
					<form action="uploadmusica" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="txtNomeMusica">Nome da Música:</label> <input
						...
						<div class="form-group">
							<label for="txtAlbum">Álbum:</label> <input type="text"
						...
						<div class="form-group">
							...
							<small>Tamanho máximo permitido 20MB</small>
						</div>
